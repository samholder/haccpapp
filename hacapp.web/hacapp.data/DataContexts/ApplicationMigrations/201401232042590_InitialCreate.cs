namespace Hacapp.Data.DataContexts.ApplicationMigrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PreferredEmailAddress = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TeamMemberships", "Team_Id", "dbo.Teams");
            DropForeignKey("dbo.TeamMemberships", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.Teams", new[] { "Owner_Id" });
            DropIndex("dbo.TeamMemberships", new[] { "Team_Id" });
            DropIndex("dbo.TeamMemberships", new[] { "User_Id" });
